...
export default function VendorMenuPage() {
  ...
  return (
    <VendorLayout>
      <div className="px-4 pt-4 space-y-4 md:px-6 lg:px-8">
        <div>
        ...
        <div className="grid gap-4 lg:grid-cols-12 lg:items-start">
          <div className="bg-white rounded-xl border border-border p-4 space-y-3 lg:col-span-4 lg:sticky lg:top-20">
